...
<script>
    var handlerPopup = function (captchaObj) {
        $("#popup-submit").click(function () {
            ...
            $.ajax({
                url: "<?php echo \yii\helpers\Url::to(['verify']) ?>", // 进行二次验证
                type: "post",
                // dataType: "json",
                data: {
                    // 二次验证所需的三个值
    ...
    $.ajax({
        ...
        url: "<?php echo \yii\helpers\Url::to(['startcaptcha']) ?>", // 加随机数防止缓存
        type: "get",
        dataType: "json",
...
<hr>
<br><br>
<form class="popup" action="<?php echo \yii\helpers\Url::to(['verify']) ?>" method="post">
